    ...
    <modal name="register" height="auto" v-cloak>
        <form class="p-10" @submit.prevent="register">
            <div class="mb-6">
                ...
                <input type="text" class="w-full p-2 leading-normal" id="name" name="name" autocomplete="name" placeholder="John Doe" value="<?php echo e(old('name')); ?>" required v-model="form.name" @keydown="errors.name = false">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="w-full p-2 leading-normal" id="username" name="username" autocomplete="username" placeholder="johndoe" value="<?php echo e(old('username')); ?>" required v-model="form.username" @keydown="errors.username = false">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="w-full p-2 leading-normal" id="email" name="email" autocomplete="email" placeholder="joe@example.com" value="<?php echo e(old('email')); ?>" required v-model="form.email" @keydown="errors.email = false">
