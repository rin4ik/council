    ...
    <modal name="login" height="auto" v-cloak>
        <form class="p-10" @submit.prevent="login" @keydown="feedback = ''">
            <div class="mb-6">
                ...
                <input type="text" class="w-full p-2 leading-normal" id="email" name="email" autocomplete="email" placeholder="joe@example.com" value="<?php echo e(old('email')); ?>" required v-model="form.email">
            </div>
            ...
            <div class="flex justify-end items-center">
                <button type="submit" class="btn uppercase text-xs bg-blue  mr-4" :class="loading ? 'loader' : ''" :disabled="loading">Log In</button>
                <a href="#" class="text-xs text-grey-dark no-underline" @click="register">or register</a>
            </div>
